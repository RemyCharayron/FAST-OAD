...
class Cabin(ComponentGeometry):
    def __init__(self):
        ...
        self.aisle_width: float = 0.
        """ width of aisle (in meters) """

        self.aisle_count: int = 0
        """ count of aisles """

        self.emergency_exit_width: float = 0.
